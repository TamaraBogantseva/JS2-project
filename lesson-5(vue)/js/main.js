const Shop = {
    data() {
        return {
            ...
            deleteFtomCartUrl: '/deleteFromBasket.json',
            cartProducts: [],
    ...
    methods: {
        ...
        deleteProduct(product) {
            this.getJson(`${this.API + this.deleteFtomCartUrl}`)
                .then(data => {
                    if (data.result) {
    ...
    mounted() {
        ...
        this.getJson(`${this.API + this.cartUrl}`) //получаем товары с сервера в корзину
            .then(data => {
